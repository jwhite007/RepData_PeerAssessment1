...
```
The mean and median of the total steps per day are `r mean_tspd` and `r median_tspd`, respectively.  
...
```
The interval with maximum number of steps averaged across days is `r ims`.  
...
```
The number of missing values in the base data set is `r mvalues`  
...
```
The mean and median of the total steps per day in the imputed data set are `r mean_itspd` and `r median_itspd`, respectively.  
